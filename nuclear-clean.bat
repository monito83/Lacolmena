@echo off
echo ========================================
echo    LIMPIEZA NUCLEAR - La Colmena
echo ========================================
echo.

echo [1/8] Matando TODOS los procesos de Node.js...
...
echo.
echo [2/8] Esperando 5 segundos...
timeout /t 5 /nobreak >nul

echo.
echo [3/8] Matando procesos por puerto específico...
...
echo.
echo [4/8] Limpiando cache completo...
...
echo.
echo [5/8] Verificando puertos libres...
echo Puerto 3001:
...
echo.
echo [6/8] Esperando 3 segundos más...
timeout /t 3 /nobreak >nul

echo.
echo [7/8] Reinstalando dependencias del frontend...
cd frontend
npm install >nul 2>&1
cd ..
